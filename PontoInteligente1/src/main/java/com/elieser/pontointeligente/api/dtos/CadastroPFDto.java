package com.elieser.pontointeligente.api.dtos;
...
public class CadastroPFDto {
	...
	private String cpf;
	private Optional<String> valorHora = Optional.empty(); //inicializa com valor é opcional que pode não estar presente
